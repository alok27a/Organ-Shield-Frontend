...
const History = () => {
    ...
    const getDonorDetails = async () => {
        ...
        const result = await fetch("https://organ-shield-backend.vercel.app/hospital/donor", {
            method: "GET",
            headers: {
        ...
        if (tes.success) {
            ...
            toast({
                title: 'Error!',
                description: "Error Fetching Donors",
                status: 'error',
                duration: 9000,
                isClosable: true,
            })
    ...
    const donorDetailsClicked = async (id) => {
        ...
        console.log(id)
        let result = await fetch(`https://organ-shield-backend.vercel.app/hospital/donor/${id}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                'Accept': 'application/json',
    ...
    return (
        <Sidebar>
            <Breadcrumbs links={["Home", "Dashboard", "Donors"]} />
            <Heading mt={8} ml={4}>
                Donors
            </Heading>
            <Stack p={4} gap={3}>
